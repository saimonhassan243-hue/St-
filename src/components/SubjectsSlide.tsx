          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                আবশ্যিক ও বিভাগীয় বিষয়সমূহ, অধ্যায়ভিত্তিক টাস্ক অগ্রগতি ও এক্সাম রিস্ক ট্র্যাকিং
              </p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold px-3 py-1.5 rounded-xl bg-indigo-500/15 text-indigo-300 border border-indigo-500/30 font-anek">
              মোট অধ্যায়: {toBengaliNumber(activeFilteredChaptersCount)}টি
            </span>
          </div>
        </div>

        {/* Custom Syllabus Filter Top Bar & Search/Filters */}
